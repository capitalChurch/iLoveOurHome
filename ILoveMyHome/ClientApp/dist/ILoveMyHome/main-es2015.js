...
class ButtonPersonalizedComponent {
    constructor() {
...
class HowMuchIsMissingComponent {
    constructor(translateService) {
        this.translateService = translateService;
...
class TranslateService {
    constructor() {
        ...
        this.setupBrowserLanguage = () => {
            ...
            const lang = languages.findOrFirst(x => x.browseLang === navigator.language).lang;
            this.use(lang);
        };
        this.setupBrowserLanguage();
    }
